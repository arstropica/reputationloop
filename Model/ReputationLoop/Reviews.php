 ...
 *        
 */
class Reviews implements \Iterator, \Countable, \ArrayAccess {
	...
	public function remove($key) {
		if (! isset ( $this->_elements [$key] ) && ! array_key_exists ( $key, 
				$this->_elements )) {
			return null;
		}
	...
	public function containsKey($key) {
		return isset ( $this->_elements [$key] ) || array_key_exists ( $key, 
				$this->_elements );
	}
